...
var (
	orderColumns               = []string{"id", "status", "product_id", "created_at", "updated_at"}
	orderColumnsWithoutDefault = []string{"status", "product_id", "created_at", "updated_at"}
...
func (o OrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no Order slice provided for delete all")
	}
